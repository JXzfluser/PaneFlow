        ...
        {full && (
          <>
            ...
            <ul>
              ...
              <li><b>模板云端同步</b>（可选）：服务端配置 <kbd>PF_GITHUB_REPO</kbd> / <kbd>PF_GITHUB_TOKEN</kbd> 后，顶栏「⋯ 更多」里的「沉淀 / 拉取」可双向同步模板。未配置时功能会提示而不干扰。</li>
              <li><b>项目</b>：左侧栏「项目」视图总览全部项目——点卡片即切换、可新建；「编辑档案」就地配主仓根/约定文档/班底（v10-W 起档案不再在设置页）。运行记录按项目隔离，编排模板全局共享。</li>
            </ul>
